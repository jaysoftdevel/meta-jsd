...
#define COIL_PIN_EAST	GPIO_TO_PIN(0, 8)	// P8_35  green
#define COIL_PIN_SOUTH	GPIO_TO_PIN(2, 17)	// P8_34, 
#define COIL_PIN_WEST	GPIO_TO_PIN(0, 9)	// P8_33, blue
...
int initStepperLGpio(void);
int deinitStepperLGpio(void);
int stepLNone(void);
int stepFwdL(void);
int stepRevL(void);
